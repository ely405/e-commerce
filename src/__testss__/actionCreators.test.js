import { addToCartAction, loadProductsAction, removeFromCartAction } from '../actionCreators';
...
describe('Testing actionCreators sync', () => {
    ...
    it('Remove a product from cart', () => {
        const store = mockStore( { cart: [{ id:2, name: 'producto 2', price: 50, image: '' }, { id:3, name: 'producto 3', price: 50, image: '' }] });
        const productToRemove = { id:2, name: 'producto 2', price: 50, image: '' };
        const actions = store.getActions();
