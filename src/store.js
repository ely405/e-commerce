...
import { productReducer, cartReducer, modalReducer, successMessageReducer } from './reducers';
...
const reducerCombined = combineReducers({ cart: cartReducer, products: productReducer, modal: modalReducer, successMessage: successMessageReducer });
